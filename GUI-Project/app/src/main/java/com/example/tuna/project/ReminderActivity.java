        ...
        show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cb1.isChecked()){
                    ...
                    manager_teeth.setInexactRepeating(AlarmManager.RTC_WAKEUP,calendar_teeth.getTimeInMillis(),1000*60*1*1,alarmintent_teeth);
                ...
                if(cb2.isChecked()){
                    ...
                    manager_pill.setInexactRepeating(AlarmManager.RTC_WAKEUP,calendar_pill.getTimeInMillis(),1000*60*60*12,alarmintent_pill);
                ...
                if(cb3.isChecked()){
                    ...
                    manager_water.setInexactRepeating(AlarmManager.RTC_WAKEUP,calendar_water.getTimeInMillis(),1000*60*60*3,alarmintent_water);
                    }
                if(cb4.isChecked()){
                    noti = noti+1 ;

                    Calendar calendar_dish=Calendar.getInstance();
                    calendar_dish.set(Calendar.HOUR_OF_DAY,20);
                    ...
                    manager_dish.setInexactRepeating(AlarmManager.RTC_WAKEUP,calendar_dish.getTimeInMillis(),1000*60*60*24,alarmintent_dish);
                    }
                if(cb5.isChecked()){
                    noti = noti+1 ;
                    ...
                    calendar_clothes.set(Calendar.HOUR_OF_DAY,12);
                ...
                if(cb6.isChecked()){
                    ...
                    manager_rub.setInexactRepeating(AlarmManager.RTC_WAKEUP, calendar_rubbish.getTimeInMillis(),1000*60*60*12,alarmintent_rub);
                    }
                if(cb7.isChecked()){
                    noti = noti+1 ;
