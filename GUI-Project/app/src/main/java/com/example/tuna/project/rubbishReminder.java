...
public class rubbishReminder extends Service {
    android.support.v4.app.NotificationCompat.Builder notification;
    private static final int uniqueID=  6;
    ...
    public void onStart(Intent intent, int startId) {
        ...
        Log.d("rubbishReminder", "onCreate");
        setNotification();
    ...
    public void setNotification(){
        ...
        notification.setContentText("Throw Away Rubbish!");

        Intent noti = new Intent(this,rubbishReminder.class);
