...
public class dishReminder extends Service {
    android.support.v4.app.NotificationCompat.Builder notification;
    private static final int uniqueID=  4;
    ...
    public void setNotification(){
        ...
        notification.setContentText("Wash Dishes!");

        Intent noti = new Intent(this,dishReminder.class);
