...
public class waterReminder extends Service {
    ...
    public void setNotification(){
        ...
        notification.setContentText("Drink water!");

        Intent noti = new Intent(this,waterReminder.class);
